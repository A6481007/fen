...
async function requireAdminAccess() {
  ...
  try {
    ...
    console.warn("[promotions][campaigns] auth unavailable", error);
    userId = null;
  }
  if (!userId) {
...
async function handleGetCampaigns(request: NextRequest) {
  try {
...
export const GET = withRateLimit(handleGetCampaigns, "campaigns");
