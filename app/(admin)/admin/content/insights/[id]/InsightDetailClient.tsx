      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <Separator />
            <div className="flex items-center justify-between">
              <span className="text-slate-500">{t("admin.content.insights.detail.fields.heroLayout", "Hero layout")}</span>
              <span className="font-medium capitalize">{insight.heroLayout || t("admin.content.insights.detail.values.notSet")}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-slate-500">{t("admin.content.insights.detail.fields.heroTheme", "Hero theme")}</span>
              <span className="font-medium capitalize">{insight.heroTheme || t("admin.content.insights.detail.values.notSet")}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-slate-500">{t("admin.content.insights.detail.fields.heroImage", "Hero image")}</span>
              <span className="font-medium">
                {insight.heroImage?.asset?._ref
