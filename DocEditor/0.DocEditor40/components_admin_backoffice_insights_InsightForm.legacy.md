...
const InsightForm = ({
  ...
  const fieldRegistry: FieldRegistry = {
    ...
    heroAlt: () => (
      <div className="space-y-2">
        <Label htmlFor="heroAlt">{t("admin.content.insights.form.hero.alt", "Alt text")}</Label>
        <Input
          id="heroAlt"
    ...
    heroCaption: () => (
      <div className="space-y-2">
        <Label htmlFor="heroCaption">{t("admin.content.insights.form.hero.caption", "Caption")}</Label>
        <Input
          id="heroCaption"
    ...
    heroLayout: () => (
      <div className="space-y-2">
        <Label htmlFor="heroLayout">{t("admin.content.insights.form.hero.layoutLabel", "Layout")}</Label>
        <Select
    ...
    heroTheme: () => (
      <div className="space-y-2">
        <Label htmlFor="heroTheme">{t("admin.content.insights.form.hero.themeLabel", "Theme")}</Label>
        <Select
