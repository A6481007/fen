...
const NewsForm = ({
  ...
  const fieldRegistry: FieldRegistry = {
    ...
    heroAlt: () => (
      <div className="space-y-2">
        <Label htmlFor="heroAlt">{t("admin.news.hero.altLabel", "Alt text")}</Label>
        <Input
          id="heroAlt"
    ...
    heroCaption: () => (
      <div className="space-y-2">
        <Label htmlFor="heroCaption">{t("admin.news.hero.captionLabel", "Caption")}</Label>
        <Input
          id="heroCaption"
    ...
    seoKeywords: () => (
      <div className="space-y-2">
        <Label htmlFor="seoKeywords">{t("admin.news.seo.keywords", "Keywords")}</Label>
        <Input
          id="seoKeywords"
