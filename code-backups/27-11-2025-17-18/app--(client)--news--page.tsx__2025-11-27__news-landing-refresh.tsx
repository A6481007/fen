...
const NewsPage = async ({
  ...
  const newsItems = await getAllBlogs(12);
  ...
  // Extract description from portable text body
          ...
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-sm sm:text-base md:text-lg text-white/90 mb-6 max-w-2xl mx-auto">
                Release notes, events, and resources — all in one place so you
                never miss an important update from our team.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-md mx-auto">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4">
                  <div className="flex items-center gap-2 text-white/80 mb-1">
                    ...
                    <span className="text-xs sm:text-sm">News items</span>
                  </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 col-span-2 sm:col-span-1">
                  ...
                  <p className="text-xl sm:text-2xl font-bold">Coming soon</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Stay up to date with product announcements, events, and resources.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Browse articles, events, and resources.
            </p>
          </div>

          {/* TODO: Wire up server-side filtering once Sanity content types are ready. */}
              ...
              >
                {newsItem?.mainImage && (
                  <div className="relative overflow-hidden">
                    ...
                    {/* TODO: Update to /news/${newsItem?.slug?.current} once dedicated route exists. */}
                    <Link
                    ...
                    {/* Category Badge */}
                    {newsItem?.blogcategories &&
                      newsItem.blogcategories.length > 0 && (
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="flex items-center gap-4 text-xs sm:text-sm text-gray-500 mb-3">
                    ...
                    <div className="flex items-center gap-1">
                      <Clock size={14} />
                      {calculateReadingTime(newsItem?.title || "")} min read
                    </div>
                  </div>
                  ...
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3">
                    {extractDescription(newsItem?.body || [])}
                  </p>
          ...
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-6">
                Subscribe to get product updates, event announcements, and helpful
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/news">Browse Resources</Link>
                </Button>
              </div>
            </div>
          </CardContent>
