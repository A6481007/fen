...
export function ImageInsertModal({ open, onClose, onInsert }: ImageInsertModalProps) {
  ...
  const altTooLong = altLength > 125;
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-end text-[11px] font-medium text-slate-400">
                <span className={altTooLong ? "text-amber-500" : "text-slate-400"}>{altLength} / 125 chars</span>
              </div>
              <p className={`text-[11px] transition-opacity duration-150 ${altTooLong ? "text-amber-500" : "opacity-0"}`}>
