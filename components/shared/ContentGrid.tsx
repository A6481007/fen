...
/**
 * Generic grid/list wrapper that standardizes loading/empty/error states, gap/column fallbacks,
 * and list roles for adapters that render ContentCard derivatives.
 */
...
const ContentGrid = <T,>({
  ...
  // List mode sets semantic roles; grid mode falls back to inline grid-template when counts are unsupported.
