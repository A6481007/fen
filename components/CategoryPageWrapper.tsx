    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 bg-white rounded-lg">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 bg-brand-text-main text-white px-4 py-2 rounded-lg hover:bg-brand-black-strong transition-colors"
        >
              ...
              >
                ...
                <div className="w-12 h-12 mx-auto mb-3 bg-gradient-to-br from-brand-border to-brand-background-subtle rounded-lg flex items-center justify-center">
                  {category.image ? (
                    ...
                    <Package className="w-6 h-6 text-brand-text-main opacity-60" />
                  )}
                </div>
