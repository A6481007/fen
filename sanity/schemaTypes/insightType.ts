...
export const insightType = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "primaryKeyword",
      title: "Primary Keyword (EN)",
      type: "string",
      fieldset: "seo",
      description: "English primary keyword for SEO. Add the Thai variant below.",
    }),
    defineField({
      name: "primaryKeywordTh",
      title: "Primary Keyword (TH)",
      type: "string",
      fieldset: "seo",
      description: "Thai primary keyword shown when viewing the Thai locale.",
    }),
    defineField({
      ...
      type: "number",
      fieldset: "seo",
      validation: (Rule) => Rule.required().integer().min(1).error("Must be a positive integer"),
    }),
    defineField({
