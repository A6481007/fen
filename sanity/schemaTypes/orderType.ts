      ...
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({
              name: "priceOptionId",
              title: "Price Option ID",
              type: "string",
              description: "Selected price option key (if applicable).",
            }),
            defineField({
              name: "priceOptionLabel",
              title: "Price Option Label",
              type: "string",
              description: "Selected price option label (if applicable).",
            }),
            defineField({
              name: "quantity",
