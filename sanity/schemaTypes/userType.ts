    ...
    defineField({
      ...
      of: [
        defineArrayMember({
          ...
          options: {
            list: [
              { title: "Content Admin", value: "content_admin" },
              { title: "Insight Editor", value: "insight_editor" },
              { title: "News Editor", value: "news_editor" },
              { title: "Event Manager", value: "event_manager" },
              { title: "Marketing Admin", value: "marketing_admin" },
              { title: "Promotions Manager", value: "promotions_manager" },
              { title: "Deals Manager", value: "deals_manager" },
              { title: "Communications Manager", value: "comms_manager" },
              { title: "Analyst (Read-only)", value: "analyst_readonly" },
            ],
          },
        }),
      ],
      description: "Backoffice staff roles for content, marketing, and communications",
    }),
    defineField({
      name: "staffStatus",
      title: "Staff Status",
      ...
      initialValue: "active",
      hidden: ({ document }) =>
        !Array.isArray(document?.staffRoles) || document.staffRoles.length === 0,
      description: "Current staff status for backoffice access",
    }),
    defineField({
      name: "staffAssignedBy",
      title: "Staff Assigned By",
      type: "string",
      description: "Email of admin who assigned staff roles",
      hidden: ({ document }) =>
        !Array.isArray(document?.staffRoles) || document.staffRoles.length === 0,
    }),
    defineField({
      ...
      type: "datetime",
      description: "When staff roles were assigned",
      hidden: ({ document }) =>
        !Array.isArray(document?.staffRoles) || document.staffRoles.length === 0,
    }),
    // Employee fields
